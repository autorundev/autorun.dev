...
export const commands = {
  ...
  'red pill': {
    lines: [
      ...
      { mark: '[+]', text: '****.** unlocked' },
      { mark: null,  text: '****.** \u2192 trading agents', indent: true },
      { mark: null,  text: '' },
      { mark: null,  text: 'cross-exchange arbitrage, signal detection, execution', indent: true },
      { mark: null,  text: 'stealth beta with ~40 users', indent: true },
