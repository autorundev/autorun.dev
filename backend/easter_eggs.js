...
export const commands = {
  ...
  'sudo make me a sandwich': {
    lines: [
      { mark: '[/]', text: 'toasting bread',               spinner: true, duration: 700 },
      { mark: '[*]', text: 'toasting bread' },
      { mark: '[/]', text: 'slicing tomato',               spinner: true, duration: 600 },
      { mark: '[*]', text: 'slicing tomato' },
      { mark: '[/]', text: 'layering cheese and lettuce',  spinner: true, duration: 700 },
      { mark: '[*]', text: 'layering cheese and lettuce' },
      { mark: '[/]', text: 'applying mayo',                spinner: true, duration: 500 },
      { mark: '[!]', text: 'mayo drift detected' },
      { mark: '[/]', text: 'recalibrating mayo',           spinner: true, duration: 400 },
      { mark: '[*]', text: 'mayo within tolerance' },
      { mark: '[/]', text: 'plating',                      spinner: true, duration: 500 },
